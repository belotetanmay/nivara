...
import { Sparkles, MapPin, Upload, ChevronLeft, AlertCircle, CheckCircle, RefreshCw } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        setError(data.error || 'Failed to create van listing.');
      ...
      <main className="flex-grow max-w-4xl mx-auto w-full px-4 py-12 sm:px-6">
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-xl border border-[#E5E1D8] shadow-md space-y-6">
            <div>
              <h1 className="font-serif text-2xl sm:text-3xl font-bold tracking-tight text-primary">Register New Wellness Van</h1>
              <p className="text-xs text-muted-foreground mt-1">Submit your relaxation vehicle for administration review and vetting.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 text-xs text-primary">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. Zen Cabin Bangalore East"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Describe the relaxation atmosphere, seating, noise levels, and aromatics setup..."
              ...
              <div className="pt-4 flex gap-4">
                ...
                >
                  {isSubmitting ? 'Registering Cabin...' : 'Submit Cabin for Vetting'}
                </button>
                <Link
                  href="/vendor/vans"
