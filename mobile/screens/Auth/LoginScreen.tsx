    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.cardContainer}>
          ...
          <Text style={styles.subtitleText}>Sign in to locate and book your wellness pod.</Text>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#FAF8F5', // Cream light background
  },
  scrollContainer: {
    flexGrow: 1,
  ...
  taglineText: {
    fontSize: 13,
    color: '#2C5234', // Forest Green secondary brand color
    marginTop: 6,
    letterSpacing: 1,
    fontWeight: '500',
  },
  cardContainer: {
    ...
    elevation: 4,
    borderWidth: 1,
    borderColor: '#E5E1D8', // Brand border color
  },
  titleText: {
    fontSize: 22,
    fontWeight: 'bold',
  ...
  errorContainer: {
    ...
    borderWidth: 1,
    borderColor: '#D4A373', // Amber accent border
    borderRadius: 12,
    padding: 12,
    marginBottom: 20,
  },
  ...
  button: {
    backgroundColor: '#0A2540', // Deep Navy brand primary button
    borderRadius: 14,
    height: 52,
    justifyContent: 'center',
    alignItems: 'center',
  ...
  footerLink: {
    color: '#2C5234', // Forest Green link text
    fontWeight: 'bold',
    fontSize: 14,
  },
});
